            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <motion.div
                        ...
                        className="group relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-secondary/20 to-secondary/20 hover:border-foreground transition-all duration-300 cursor-pointer"
                        onClick={() => router.push('/events/crazy-winter')}
                    >
                        {/* Image/Banner Placeholder */}
                        <div className="h-48 bg-gradient-to-br from-foreground/20 to-cyan-400/20 flex items-center justify-center relative overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="text-2xl font-bold mb-2 group-hover:text-foreground transition-colors">Crazy Winter</h3>
