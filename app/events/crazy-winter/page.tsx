    ...
    return (
        <div className="min-h-screen bg-[#0b1026] text-white relative overflow-hidden pb-20">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-secondary/20 via-[#0b1026] to-[#0b1026]"></div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto p-4 md:p-8 pt-24">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-blue-200 to-white bg-clip-text text-transparent flex items-center gap-3">
                                Crazy Winter <Snowflake className="w-8 h-8 text-foreground animate-spin-slow" />
                            </h1>
                            <p className="text-foreground mt-2">Complete events, earn rewards, and defeat the Yeti!</p>
                        </div>
                    </div>

                    <Button
                        onClick={() => setShowQuiz(true)}
                        className="bg-gradient-to-r from-pink-500 to-secondary hover:from-pink-600 hover:to-purple-700 text-white shadow-lg shadow-secondary/50 animate-pulse"
                    >
                ...
                {userId ? (
                    <div className="space-y-8">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md shadow-2xl shadow-secondary/20 relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10">
                                <Snowflake className="w-64 h-64 text-white" />
                            </div>
                            <div className="text-center mb-8 relative z-10">
                                <h2 className="text-2xl font-bold text-foreground">Daily Lucky Spin</h2>
                                <p className="text-sm text-foreground">Spin to win Tokens & Coupons!</p>
                            </div>
