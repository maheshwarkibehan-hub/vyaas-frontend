...
export default function CodeModePage() {
    ...
    const handleGenerate = async () => {
        ...
        const sub = await getUserSubscription(auth.currentUser.uid);
        if (!sub || ((sub.code_tokens ?? 0) <= 0 && (sub.credits ?? 0) < COSTS.CODE_MODE)) {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-foreground rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
                ...
                >
                    ...
                    <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8">
                        ...
                        <button
                            ...
                            className="mt-4 w-full px-6 py-4 bg-gradient-to-r from-green-600 to-foreground hover:from-green-500 hover:to-foreground rounded-xl font-bold text-lg shadow-lg shadow-green-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {loading ? (
                                <>
