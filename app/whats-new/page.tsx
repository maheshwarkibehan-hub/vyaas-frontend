        ...
        <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] to-[#1a0a2e] text-white">
            ...
            <header className="relative overflow-hidden">
                ...
                <motion.div
                    ...
                    className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-secondary/30 to-pink-500/30 rounded-full blur-3xl"
                />
                ...
                <div className="relative max-w-6xl mx-auto px-4 py-20 text-center">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-secondary/20 to-pink-500/20 border border-foreground mb-6"
                    >
            ...
            <div className="max-w-6xl mx-auto px-4 py-16 space-y-16">
                ...
                <FeatureSection
                    ...
                    gradient="from-secondary to-foreground"
                />
                ...
                <FeatureSection
                    ...
                    gradient="from-foreground to-cyan-600"
                />
