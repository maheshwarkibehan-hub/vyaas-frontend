...
const PATCHES = [
    {
        ...
        description: 'Complete redesign of mobile experience with improved touch targets, better spacing, and Android navigation bar support.',
        changes: [
            'Improved Mobile Responsive Design',
            'Larger Touch Targets (48px buttons)',
            'Android Navigation Bar Safe Area Fix',
            'Better Control Bar for Phones',
            'Optimized Hero Section for Mobile',
            'Improved Font Sizes & Spacing',
            'Better Navbar with Backdrop Blur',
            'Logo Animation on Welcome Screen',
            'Darker Control Bar Background'
        ]
    },
    {
        version: 'v2.3',
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white p-4 md:p-8 pt-24 relative overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none">
                ...
                <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-foreground rounded-full blur-[100px]"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-foreground rounded-full blur-[100px]"></div>
            </div>
                ...
                <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
                    {PATCHES.map((patch, index) => (
                        ...
                        >
                            ...
                            {/* Content Card */}
                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-foreground transition-all duration-300 shadow-lg backdrop-blur-sm">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-2">
                                        <Tag className="w-4 h-4 text-foreground" />
                                        <span className="font-bold text-lg text-foreground">{patch.version}</span>
                                    </div>
