...
export default function AnalyticsPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white p-8 font-sans selection:bg-foreground">
            {/* Header */}
                                        ...
                                        <tr key={t.id} className="hover:bg-white/5 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-secondary to-foreground flex items-center justify-center text-xs font-bold">
