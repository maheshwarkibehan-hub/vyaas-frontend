...
export function WhatsNewModal({ onClose }: WhatsNewModalProps) {
    ...
    useEffect(() => {
        // Skip for desktop app (running on localhost:3000 via Pywebview)
        ...
        if (isDesktopApp) {
            console.log('Desktop app detected - skipping What\'s New modal');
            return;
        }
                    ...
                    >
                        <div className="relative w-full max-w-lg bg-gradient-to-br from-[#1a1a1c] to-[#0a0a0c] border border-white/10 rounded-3xl shadow-2xl overflow-hidden">
                            ...
                            <div className="relative p-8 pb-6 overflow-hidden">
                                {/* Animated Background */}
                                <div className="absolute inset-0 bg-gradient-to-br from-secondary/20 to-pink-600/20" />
                                <motion.div
                                    animate={{
                                        scale: [1, 1.2, 1],
                                        rotate: [0, 180, 360],
                                    ...
                                    className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-secondary/30 to-pink-500/30 rounded-full blur-3xl"
                                />
                                ...
                                <div className="relative z-10">
                                    <motion.div
                                        ...
                                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-secondary/20 to-pink-500/20 border border-foreground mb-4"
                                    >
                            ...
                            <div className="p-8 pt-4 flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-6 py-3 rounded-xl bg-gradient-to-r from-secondary to-pink-600 hover:from-secondary hover:to-pink-500 text-white font-bold shadow-lg shadow-secondary/50 transition-all hover:scale-105"
                                >
                                    Explore What&apos;s New
                                </button>
                            </div>
...
function FeatureItem({ icon, title, description, delay }: FeatureItemProps) {
    return (
        ...
        >
            <div className="p-2 rounded-lg bg-gradient-to-br from-secondary/20 to-pink-500/20 text-foreground group-hover:scale-110 transition-transform">
                {icon}
            </div>
