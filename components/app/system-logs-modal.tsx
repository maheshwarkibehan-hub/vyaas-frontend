                        ...
                        <div className="flex h-[calc(100%-52px)]">
                            ...
                            <div className="w-56 border-r border-cyan-500/10 p-4 space-y-4 bg-[#080808]">
                                ...
                                <div className="p-3 rounded-lg bg-[#151515] border border-white/5">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className={cn("text-xs font-mono", stats.cpu > 80 ? 'text-red-400' : 'text-foreground')}>
                                            {stats.cpu.toFixed(1)}%
                                        </span>
                                    </div>
                                ...
                                <div className="p-3 rounded-lg bg-[#151515] border border-white/5">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className={cn("text-xs font-mono", stats.memory > 80 ? 'text-red-400' : 'text-foreground')}>
                                            {stats.memory.toFixed(1)}%
                                        </span>
                                    </div>
                                    <div className="h-1 bg-white/10 rounded-full overflow-hidden">
                                        <div className="h-full bg-foreground transition-all" style={{ width: `${stats.memory}%` }} />
                                    </div>
                                </div>
                            ...
                            <div className="flex-1 flex flex-col bg-[#050505]">
                                <div className="px-4 py-2 border-b border-white/5 flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] text-foreground font-mono animate-pulse">● STREAMING</span>
                                </div>
