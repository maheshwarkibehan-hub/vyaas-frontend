  ...
  return (
    <div className={cn('flex items-center gap-0', className)}>
      <TrackToggle
        ...
        className={cn(
          "peer/track group/track has-[.audiovisualizer]:w-auto",
          showChevron && "has-[~_button]:rounded-r-none has-[~_button]:pr-2 has-[~_button]:pl-3",
          !showChevron && "rounded-full aspect-square justify-center"
        )}
      >
        {showChevron && audioTrackRef && (
          <BarVisualizer
            barCount={3}
            options={{ minHeight: 5 }}
