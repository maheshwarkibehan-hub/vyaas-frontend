      ...
      <div className="flex items-center gap-3 md:gap-3 flex-wrap justify-center">
        ...
        {visibleControls.website && (
          <motion.button
            ...
            className="h-12 w-12 flex items-center justify-center rounded-full bg-card text-foreground shadow-clay-sm border border-white/20 transition-all hover:shadow-[0_8px_24px_-4px_rgba(255,255,255,0.1)]"
        ...
        {visibleControls.code && (
          <motion.button
            ...
            className="h-12 w-12 flex items-center justify-center rounded-full bg-foreground text-background shadow-clay-sm border border-white/20 transition-all hover:shadow-[0_8px_24px_-4px_rgba(255,255,255,0.1)]"
        ...
        {visibleControls.leave && (
          <Button
            ...
            className="h-12 px-5 rounded-full bg-foreground text-background border border-border shadow-clay-sm transition-all hover:scale-105 active:scale-95 ml-1"
          >
