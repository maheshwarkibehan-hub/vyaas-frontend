  ...
  ],
  {
    variants: {
      variant: {
        ...
        primary: 'bg-gradient-to-r from-cyan-500 to-foreground text-white hover:from-cyan-400 hover:to-foreground hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25',
