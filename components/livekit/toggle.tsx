  ...
  ],
  {
    variants: {
      variant: {
        ...
        primary:
          'bg-gradient-to-r from-cyan-500 to-foreground text-white hover:from-cyan-400 hover:to-foreground data-[state=on]:from-cyan-400 data-[state=on]:to-foreground',
        secondary:
