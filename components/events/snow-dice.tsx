...
export function SnowDice({ userId }: { userId: string }) {
    ...
    return (
        <div className="bg-gradient-to-br from-cyan-900/40 to-secondary/40 border border-cyan-500/20 p-6 rounded-2xl backdrop-blur-md relative overflow-hidden flex flex-col items-center justify-center min-h-[200px]">
