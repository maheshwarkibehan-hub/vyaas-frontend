    ...
    return (
        <div className="relative flex flex-col items-center justify-center py-12">
            ...
            <div className="relative w-80 h-80 md:w-96 md:h-96">
                ...
                {/* Center Cap */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-white shadow-xl flex items-center justify-center z-10 border-4 border-foreground">
